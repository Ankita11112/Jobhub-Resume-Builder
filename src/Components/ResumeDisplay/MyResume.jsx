    ...
    return (
        <div style={{ width: '100%', padding: '20px' }}>
            <div className='row mt-2'>
                <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
                    <Link to="/detailsfillingpage/keyskills">
                        <button style={{ padding: '10px', margin: '5px', backgroundColor: '#007bff', color: '#fff' }}> Go-Back</button>
                    </Link>
                    <button style={{ padding: '10px', margin: '5px', backgroundColor: '#28a745', color: '#fff' }} onClick={downloadComponentPDF}>
                        Save Resume
                    </button>
                </div>
            </div>
            <div className='mt-2'>
                <div style={{ display: 'flex', justifyContent: 'center', width: '100%' }}>
                    <div style={{ width: '100%' }}>
                        <div id='divToPrint' style={{ width: '1200px', margin: '0 auto' }}> {/* Fixed width for PDF */}
                ...
                <div><SuccessMessage showModal={showModal} setShow Modal={setShowModal} /></div>
            </div>
        </div>
    );
}

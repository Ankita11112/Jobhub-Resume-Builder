      ...
      <div>
        <div className='d-flex m-0  justify-content-between align-content-center '>
          ...
          <div
            className={
              dataStore.imageFile
                ? 'col-6 text-left font-weight-bold'
                : ' text-left font-weight-bold'
            }
            style={{ fontFamily: 'Serif' }}
          >
            <div className='' style={{ color: '#313131', fontSize: '55px' }}>
      ...
      <div style={{ fontFamily: 'Serif' }}>
        <div className='row'>
          ...
          <div className='col-9 text-left' style={{ fontSize: '25px' }}>
            {dataStore.workEx.map((item) => (
              <div key={shortid.generate()}>
                ...
                <div className='mt-2'>
                  Worked at {item.orgName} from {item.startYear} to{' '}
                  {item.endYear}.
                </div>
              ...
              {dataStore.education.map((item) => {
                return (
                  <div key={shortid.generate()}>
                    ...
                    <div>
                      {' '}
                      I have persued my {item.Type} in {item.Degree} from{' '}
                      {item.University}
                    </div>
          ...
          <div className='col-3 text-left mb-3 '>
            <h3 style={{ color: '#212121' }}>Key Skills</h3>
          </div>
